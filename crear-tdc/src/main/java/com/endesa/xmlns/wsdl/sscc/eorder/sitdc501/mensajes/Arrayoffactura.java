 ...
 *       &lt;sequence&gt;
 *         &lt;element name="item" type="{http://xmlns.endesa.com/wsdl/SSCC/eOrder/SITDC501/Mensajes}Factura" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Arrayoffactura {
     ...
     * 
     */
    public List<Factura> getItem() {
        if (item == null) {
            item = new ArrayList<Factura>();
        }
        return this.item;
    }
